// src/components/home/ServiceGrid.tsx (UPDATED WITH ALL ICONS)

import React from 'react';

// --- Define ALL service icons here ---
...
// --- THIS IS THE UPDATED, COMPLETE MAPPING ---
const serviceIcons: { [key: string]: JSX.Element } = {
    ...
    'On-Demand Cleaning': <HousekeepingIcon />, // Re-using Housekeeping icon as per original
