            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">
                        Manage banners displayed on your website pages
                    </p>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-full">
                    <ImageIcon size={16} />
                    <span><strong className="text-gray-800 dark:text-white">{localBanners.length}</strong> active banners</span>
                </div>
            </div>
                    ...
                    >
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                                ...
                                {/* Add New Banner Card Placeholder if Empty (Optional visual cue) */}
